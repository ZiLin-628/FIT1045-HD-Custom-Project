...
class BudgetService:
    ...
    def get_budget(self, budget_id: int) -> Budget | None:
        ...
        """
        return self.db_session.query(Budget).filter_by(id=budget_id).first()
    ...
    def get_category_budget(
        ...
        return self.db_session.query(Budget).filter_by(category_id=category.id).first()
    ...
    def get_all_budgets(self) -> list[Budget]:
        ...
        """
        return self.db_session.query(Budget).all()
